...
i = 0
#Entrada
e_texto = Entry(ventana, font=("Calibri 20")) #Pone una ventana y decimos el tipo de letra
e_texto.grid(row = 0, column = 0, columnspan = 4, padx = 50, pady = 5) #grid da mejor control primer elemento (arriba), habra 4 columnas abajo, con padx el espacio que existira en el eje x y en el eje y
